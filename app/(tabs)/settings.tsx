        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingItem}>
            <View style={styles.settingLeft}>
              ...
              <Text style={styles.settingText}>
                {translations.settingsItems.notifications}
              </Text>
            </View>
            <Switch
              value={notifications}
          ...
          <View style={styles.settingItem}>
            <View style={styles.settingLeft}>
              ...
              <Text style={styles.settingText}>
                {translations.settingsItems.darkMode}
              </Text>
            </View>
            <Switch
              value={darkMode}
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.settingItem}>
            <View style={styles.settingLeft}>
              ...
              <Text style={styles.settingText}>
                {translations.settingsItems.privacy}
              </Text>
            </View>
            <ChevronRight size={20} color="#999" />
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.settingItem}>
            <View style={styles.settingLeft}>
              ...
              <Text style={styles.settingText}>
                {translations.settingsItems.help}
              </Text>
            </View>
            <ChevronRight size={20} color="#999" />
          </TouchableOpacity>
          ...
          >
            <View style={styles.settingLeft}>
              ...
              <Text style={[styles.settingText, styles.logoutText]}>
                {translations.settingsItems.logout}
              </Text>
            </View>
          </TouchableOpacity>
        </View>
